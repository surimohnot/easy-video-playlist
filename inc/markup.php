<?php
/**
 * Add markup functions for the plugin.
 *
 ...
 * }
 */
function evp_the_icon( $args = array() ) {
	echo evp_get_icon( $args ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
}
 ...
 */
function evp_get_icon( $args = array() ) {
